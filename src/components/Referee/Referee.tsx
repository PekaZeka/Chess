...
export default function Referee() {
  ...
  const playMove = useCallback(
    (playedPiece: Piece, destination: Position): boolean => {
    ...
    [isEnPassantMove, isValidMove, pieces, updatePossibleMoves]
  );
  ...
  function handlePromotePawn(pieceType: PieceType) {
    ...
    <>
      <div className="modal-overlay hidden" ref={modalRef}>
        <div className="modal-body">
          <img
            onClick={() => handlePromotePawn(PieceType.ROOK)}
            className="promotion-piece"
            src={`/assets/images/${promotionTeamType()}_rook.png`}
            alt="rook"
          />
          <img
            onClick={() => handlePromotePawn(PieceType.BISHOP)}
            className="promotion-piece"
            src={`/assets/images/${promotionTeamType()}_bishop.png`}
            alt="bishop"
          />
          <img
            onClick={() => handlePromotePawn(PieceType.KNIGHT)}
            className="promotion-piece"
            src={`/assets/images/${promotionTeamType()}_knight.png`}
            alt="knight"
          />
          <img
            onClick={() => handlePromotePawn(PieceType.QUEEN)}
            className="promotion-piece"
